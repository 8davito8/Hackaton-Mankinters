    ...
    Menu.prototype = {
        ...
        create: function () {
            ...
            */
            ...
            var juego1 = this.game.add.text(this.game.world.centerX - 95, 50, "MINIJUEGO1", {
                font: "24px Arial",
                fill: "#FFF"
            });
            ...
            var juego3 = this.game.add.text(this.game.world.centerX - 95, 300, "MINIJUEGO3", {
                font: "24px Arial",
                fill: "#FFF"
            });
            var mapa = this.game.add.text(this.game.world.centerX - 95, 400, "Mapa", {
                font: "24px Arial",
                fill: '#FFF'
            });
            ...
            mapa.events.onInputDown.add(this.mapa, this);
